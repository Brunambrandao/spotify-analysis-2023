...
-- Método: CASE WHEN
-- Baseado nos valores reais encontrados com DISTINCT
-- ================================================
...
GROUP BY main_country_padronizado, main_music_genre_padronizado
...
WITH spotify_limpa AS (
  ...
  AND main_country IS NOT NULL
  AND main_music_genre IS NOT NULL
),
